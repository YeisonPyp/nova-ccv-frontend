// pat/components/area-consolidation-panel/area-consolidation-panel.component.ts
...
import { KpiCardComponent, KpiCardConfig } from '../kpi-card/kpi-card.component';

@Component({
  selector: 'app-area-consolidation-panel',
  standalone: true,
  imports: [CommonModule, CurrencyPipe, PatProgressBarComponent, KpiCardComponent],
